...
class ProjectExtractor(BaseExtractor):
    ...
    _PATTERNS = {
        ...
        "client_name": [
            re.compile(
                r"(?:client|employer|authority|department|organisation|customer)\s*[:\-]?\s*(.+?)(?:\n|$)",
                re.IGNORECASE,
            ),
        ],
        "nature_of_work": [
            re.compile(
                r"(?:nature\s+of\s+work|scope\s+of\s+work|type\s+of\s+work|work\s+type)\s*[:\-]?\s*(.+?)(?:\n|$)",
                re.IGNORECASE,
            ),
        ],
        "completion_date": [
    ...
    def extract_from_page(
        ...
        # Use project_name or work_order_number as entity_id
    ...
    def _page_is_relevant(
        ...
        keywords = [
            "project", "work order", "contract", "completion", "client",
            "employer", "agreement", "scope of work", "nature of work",
        ]
